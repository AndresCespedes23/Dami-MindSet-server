...
const update = (req, res) => {
    ...
    if (candidate) {
        ...
        candidate.education["institution"] = req.query.institution ? req.query.institution : candidate.education["institution"],
        candidate.education["startDate"] = req.query.startDate ? req.query.startDate : candidate.education["startDate"],
        candidate.education["finishDate"] = req.query.finishDate ? req.query.finishDate : candidate.education["finishDate"],
        candidate.education["level"] = req.query.level ? req.query.level : candidate.education["level"],
        candidate.education["inProgress"] = req.query.inProgress ? req.query.inProgress : candidate.education["inProgress"],
        candidate.education["title"] = req.query.title ? req.query.title : candidate.education["title"],
        candidate.workExperience["company"] = req.query.company ? req.query.company : candidate.company,
        candidate.workExperience["role"] = req.query.role ? req.query.role : candidate.role,
        candidate.workExperience["workStartDate"] = req.query.workStartDate ? req.query.workStartDate : candidate.workExperience["workStartDate"],
        candidate.workExperience["workFinishDate"] = req.query.workFinishDate ? req.query.workFinishDate : candidate.workExperience["workFinishDate"],
        candidate.workExperience["currently"] = req.query.currently ? req.query.currently : candidate.workExperience["currently"],
        candidate.workExperience["workDescription"] = req.query.workDescription ? req.query.workDescription : candidate.workExperience["workDescription"],
        candidate.workExperience["accomplishments"] = req.query.accomplishments ? req.query.accomplishments : candidate.workExperience["accomplishments"],
